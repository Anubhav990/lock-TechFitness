...
function TechBlog() {
    ...
    return (
        <section className="text-gray-600 dark:text-white body-font overflow-hidden md:bg-gradient-to-b dark:md:bg-gradient-to-b dark:from-gray-800 dark:via-slate-700 dark:to-gray-800 from-white to-blue-50 rounded-lg">
